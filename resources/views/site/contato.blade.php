    ...
    <div class="conteudo-pagina">
        ...
        <div class="informacao-pagina">
            <div class="contato-principal">
                @component('site.layout._components.form_contato', ['classe'=>'borda-preta', 'motivo_contatos'=>$motivo_contatos])  <!--Component -- Obs: Para adicionar View em forma de componente-->  
